...
const myFooter = () => {
       return (
                ...
                <div className="myFooter">
                     ...
                     <a href="https://www.youtube.com/conradofficial" target="_blank" rel="noreferrer"><i className="fa-brands fa-youtube"></i></a>
                     <a href="https://open.spotify.com/artist/1rw8ZTLnDHd74TWDDukjVi" target="_blank" rel="noreferrer"><i className="fa-brands fa-spotify"></i></a>
                     <a href="https://www.twitter.com/conradofficial" target="_blank" rel="noreferrer"><i className="fa-brands fa-twitter"></i></a>
